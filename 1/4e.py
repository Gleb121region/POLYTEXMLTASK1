...
def builder_plt(X, y):
    classifiers = (SVC(kernel='linear', gamma=0.1),
                   SVC(kernel='rbf', gamma=0.1),
                   SVC(kernel='sigmoid', gamma=0.1),
                   SVC(kernel='poly', degree=1, gamma=0.1),
                   SVC(kernel='poly', degree=2, gamma=0.1),
                   SVC(kernel='poly', degree=3, gamma=0.4),
                   SVC(kernel='poly', degree=4, gamma='scale'),
                   SVC(kernel='poly', degree=5, gamma='scale'))
...
if __name__ == '__main__':
    X_train, y_train = get_data('/Users/popovgleb/PycharmProjects/polytexTask/1/data/svmdata_e.txt')
    X_test, y_test = get_data('/Users/popovgleb/PycharmProjects/polytexTask/1/data/svmdata_e_test.txt')
